package com.idat.idatSindyQuispe.controller;
...
import com.idat.idatSindyQuispe.service.UsuarioClienteService;
...
public class UsuarioClienteController {
	...
	public ResponseEntity<Void> editar(@RequestBody UsuarioClienteRequestDTO usuario){
		UsuarioClienteResponseDTO usuari = service.usuarioClienteById(usuario.getIdClienteRequest());
		if(usuari != null) {
